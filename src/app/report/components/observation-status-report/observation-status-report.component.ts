...
import { ObservationType } from '../../../observation/model/observationType.model';
import { Process } from '../../../observation/model/process.model';
import { Status } from '../../../observation/model/status.model';
import { ObservationStatusFilter } from '../../../observation/model/observationStatusFilter.model';
import { ObservationStatusReport } from '../../../observation/model/observationStatusReport.model';
...
export class ObservationStatusReportComponent implements OnInit {
  ...
  exportToExcel(data: any) {
    const parsedResponse = this.ConvertToCSV(data);
