...
@Component({
  selector: 'app-incident-case-owner-dashboard',
  templateUrl: './incident-case-owner-dashboard.component.html',
  styleUrls: ['./incident-case-owner-dashboard.component.css']
})
export class IncidentCaseOwnerDashboardComponent implements OnInit {
